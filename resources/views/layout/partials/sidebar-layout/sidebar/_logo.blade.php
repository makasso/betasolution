...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	<!--begin::Logo image-->
	<a href="{{ route('dashboard') }}" class="d-flex w-100 justify-content-center">
		<img alt="Logo" src="{{ image('logos/logo.png') }}" class="h-100px w-100px object-fit-cover app-sidebar-logo-default" />
		<img alt="Logo" src="{{ image('logos/logo_small.png') }}" class="h-20px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
