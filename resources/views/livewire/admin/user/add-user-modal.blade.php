    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">{{ $edit_mode ? __('admin/app.menu.user_edit') : __('admin/app.menu.user_create') }}</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                ...
                <form id="kt_modal_add_user_form" class="form" action="#" wire:submit.prevent="submit"
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" class="btn btn-primary" data-kt-users-modal-action="submit">
                            <span class="indicator-label" wire:loading.remove>{{ $edit_mode ? __('admin/app.general.edit') : __('admin/app.general.create') }}</span>
